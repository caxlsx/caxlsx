...
class TestDateTimeConverter < Test::Unit::TestCase
  ...
  def test_date_to_serial_1900
    ...
    tests = if @extended_time_range
              ...
              { # examples taken inside the possible values
                "1970-01-01" => 25_569.0, # Unix epoch
                "1970-01-02" => 25_570.0,
                "2006-02-01" => 38_749.0,
                "2038-01-19" => 50_424.0 # max date using signed timestamp in 32bit
              }
            end
  ...
  def test_date_to_serial_1904
    ...
    tests = if @extended_time_range
              ...
              { # examples taken inside the possible values
                "1970-01-01" => 24_107.0, # Unix epoch
                "1970-01-02" => 24_108.0,
                "2006-02-01" => 37_287.0,
                "2038-01-19" => 48_962.0 # max date using signed timestamp in 32bit
              }
            end
    tests.each do |date_string, expected|
      serial = Axlsx::DateTimeConverter::date_to_serial Date.parse(date_string)
  ...
  def test_time_to_serial_1900
    ...
    tests = if @extended_time_range
              ...
              { # examples taken inside the possible values
                "1970-01-01T00:00:00Z" => 25_569.0, # Unix epoch
                "1970-01-01T12:00:00Z" => 25_569.5,
                "2000-01-01T00:00:00Z" => 36_526.0,
                "2038-01-19T03:14:07Z" => 50_424.134803 # max signed timestamp in 32bit
              }
            end
  ...
  def test_time_to_serial_1904
    ...
    tests = if @extended_time_range
              ...
              { # examples taken inside the possible values
                "1970-01-01T00:00:00Z" => 24_107.0, # Unix epoch
                "1970-01-01T12:00:00Z" => 24_107.5,
                "2000-01-01T00:00:00Z" => 35_064.0,
                "2038-01-19T03:14:07Z" => 48_962.134803 # max signed timestamp in 32bit
              }
            end
    tests.each do |time_string, expected|
      serial = Axlsx::DateTimeConverter::time_to_serial Time.parse(time_string)
